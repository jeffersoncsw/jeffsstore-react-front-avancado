...
const ListarPedidos = lazy(() => import('../Components/Pedidos/ListarPedidos.js'))
        ...
        <div className="row">
          ...
          <div className="col-lg-12 col-md-12 mx-auto">
            <table className="table table-striped">
              ...
              <tbody>
                <Suspense className={{textAlign: "center"}} fallback={<div ><Spinner animation="border" variant="primary"/></div>} >
